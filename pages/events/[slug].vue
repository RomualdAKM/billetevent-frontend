  ...
  <div>
    ...
    <div class="bg-surface border-b border-border-light overflow-x-auto">
      <div class="max-w-[1160px] mx-auto px-10 flex items-center max-md:px-5 max-sm:flex-col max-sm:px-0 max-sm:items-stretch">
        ...
        <div class="flex items-center gap-2.5 px-6 py-3.5 border-r border-border-light max-sm:whitespace-normal max-sm:px-4 max-sm:py-3 max-sm:border-r-0 max-sm:border-b max-sm:w-full">
        ...
        <div class="flex items-center gap-2.5 px-6 py-3.5 border-r border-border-light max-sm:whitespace-normal max-sm:px-4 max-sm:py-3 max-sm:border-b max-sm:border-r-0 max-sm:w-full">
          <div class="w-8 h-8 rounded-lg bg-bg-primary flex items-center justify-center shrink-0"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></div>
        ...
        <div class="flex items-center gap-2.5 px-6 py-3.5 border-r border-border-light max-sm:whitespace-normal max-sm:px-4 max-sm:py-3 max-sm:border-b max-sm:border-r-0 max-sm:w-full">
          <div class="w-8 h-8 rounded-lg bg-bg-primary flex items-center justify-center shrink-0"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
        ...
        <div class="flex items-center gap-2.5 px-6 py-3.5 max-sm:whitespace-normal max-sm:px-4 max-sm:py-3 max-sm:w-full">
