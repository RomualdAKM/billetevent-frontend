    ...
    <div class="w-full max-w-[480px] bg-surface rounded-[20px] border border-border-light px-10 py-11 ">
      ...
      <div class="grid grid-cols-2 gap-3">
        <div class="mb-4">
          ...
          <input v-model="firstName" type="text" placeholder="Awa" class="w-full px-3.5 py-2.5 border-[1.5px] rounded-lg font-sans text-[0.87rem] text-text-primary bg-surface outline-none placeholder:text-text-tertiary focus:border-orange-primary transition-colors" :class="errors.firstName ? 'border-red-error' : 'border-border-light'" @input="errors.firstName = ''" />
        ...
        <div class="mb-4">
          ...
          <input v-model="lastName" type="text" placeholder="Diallo" class="w-full px-3.5 py-2.5 border-[1.5px] rounded-lg font-sans text-[0.87rem] text-text-primary bg-surface outline-none placeholder:text-text-tertiary focus:border-orange-primary transition-colors" :class="errors.lastName ? 'border-red-error' : 'border-border-light'" @input="errors.lastName = ''" />
      ...
      <div class="mb-4">
        ...
        <input v-model="email" type="email" placeholder="you@example.com" class="w-full px-3.5 py-2.5 border-[1.5px] rounded-lg font-sans text-[0.87rem] text-text-primary bg-surface outline-none placeholder:text-text-tertiary focus:border-orange-primary transition-colors" :class="errors.email ? 'border-red-error' : 'border-border-light'" @input="errors.email = ''" />
      ...
      <div class="flex items-start gap-2.5 mb-5">
        ...
        <label for="cgu" class="text-[0.78rem] text-text-secondary leading-[1.5]">J'accepte les <a href="#" class="text-orange-primary font-medium">Conditions Générales</a> et la <a href="#" class="text-orange-primary font-medium">Politique de Confidentialité</a> de BilletEvent.</label>
      </div>
      ...
      <div class="text-center mt-5 text-[0.8rem] text-text-tertiary">
        Déjà un compte ? <NuxtLink to="/auth/login" class="text-orange-primary font-semibold">Se connecter</NuxtLink>
      </div>
