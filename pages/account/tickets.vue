    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      >
        ...
        <div class="flex-1 p-4 min-w-0 flex flex-col">
          ...
          <div v-if="ticket.eventLocation" class="flex items-center gap-1 text-xs text-text-tertiary line-clamp-1 mb-2">
            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
            <span class="truncate">{{ ticket.eventLocation }}</span>
          </div>
