...
const organizerFaq = [
  ...
  { id: 'o2', q: 'Quels sont les tarifs pour les organisateurs ?', a: "BilletEvent prélève une commission de 7 % sur chaque billet vendu. Cette commission couvre l'hébergement de votre page événement, le traitement des paiements, les outils de gestion des participants et le support technique. La création d'événements gratuits avec inscription est offerte sans frais." },
